...
function RAM_FARNAM_AR_Power_all_vertex_roi_electrode_all_sameBL(i,subject_name)
...
for task_i=1:2
    ...
    eval(['sum_traces_' task_name{task_i} '=squeeze(sum_traces(:,1,band_i,:));'])
...
for task_i=1:2
    ...
    figure;
    plot(squeeze(zscore_traces(:,1,band_i,:))')
    ylim([-10 20])
