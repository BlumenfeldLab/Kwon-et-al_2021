...
file_suffix='Wendy';
data_location='E:\RAM data set\RAM_Public_Data_all\FR1_final';
image_storage_folder = [data_location '/Storage_filtering_no_overlap/Image_storage/' file_suffix '_merge/ROIs'];
            ...
            if ROI_list(ROI_i,1) < 0
                ...
                if ~isempty(L_MontageMap)
                    if size(L_MontageMap,1)==1
                        ...
                        all_zscore_traces=[all_zscore_traces ; mean_buffer_zscore_traces];
                    end
                end
            else
                load(['R_MontageMap_' Montage_suffix '.mat']);
