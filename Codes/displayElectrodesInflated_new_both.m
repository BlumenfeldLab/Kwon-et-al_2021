...
function displayElectrodesInflated_new_both(data_location, patients, overlay, laterality, views, inflationstep ,electrodeDensity, electrodeDisplay, thr,mean_flag,color_range,file_suffix,Montage_suffix,statistic_flag)
...
%         total_num_frames = 121;
    ...
    for e = 1:electrode_mapping_times
        scatter_count = 0;
        electrode_both_idx=zeros(size(patients,1),1);
