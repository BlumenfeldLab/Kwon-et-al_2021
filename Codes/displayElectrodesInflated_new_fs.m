...
function displayElectrodesInflated_new_fs(data_location, patients, overlay, figure_type, views, electrodeDensity, electrodeDisplay, ...
    thr,mean_flag,color_range,file_suffix,storage_suffix,Montage_suffix,all_sub_index,colormap_mat)


if electrodeDisplay == 1 | electrodeDensity == 1
...
%         load('cmap_hunki_10to15.mat');   
        ...
        vertex_values_sum_all=zeros(v_num,total_num_frames);
        for frame_index = 1:total_num_frames
...
%                         end
                ...
                elseif ~electrodeDensity & electrodeDisplay
