function Final_pipeline_displayElectrodesInflated_HK(data_location,r_sublist,all_sub_index, ...
    Montage_suffix,file_suffix,storage_suffix,flip_flag,zscore_mapping_flag,Cluster_based_statistics_flag, ...
    tscore_mapping_flag,tscore_mapping_flag_raw,zscore_mapping_stats_flag,atlas_index,cluster_stats_all,zscore_flag, ...
...
%         colormap_mat='cmap_hunki_new.mat';
        ...
        % make figures
        displayElectrodesInflated_new_fs(data_location, patients, overlay, laterality, ...
    ...
    %% tscore mapping on both hemispheres
    if tscore_mapping_flag == 1
        
        if zscore_flag == 1
            thr=2;
            color_range=z_color_range;
            colormap_mat='cmap_hunki_new.mat';
            colormap_label='z-score';
        else
            thr=1;
            color_range=t_color_range;
%         colormap_mat='cmap_hunki_tmap.mat';
            colormap_mat='cmap_hunki_tmap_raw.mat';
            colormap_label='t-score';
        end
        % make figures
        for cluster_stats_i=1:size(cluster_stats_all,2)
            for time_i=[5]
                displayElectrodesInflated_new_fs_stat_cluster(data_location,patients, overlay, laterality, views,thr,color_range,colormap_mat, ...
                    file_suffix,storage_suffix,Montage_suffix,cluster_stats_all{cluster_stats_i},atlas_storage_folder,atlas_index,flip_prefix,time_i,zscore_flag)
                r_time=(time_i+1)*25;
                stats_storage_folder=[image_storage_folder '\' atlas_index '_' cluster_stats_all{cluster_stats_i} '_' num2str(r_time) 'ms'];
    ...
    %% raw tscore mapping on both hemispheres
    if tscore_mapping_flag_raw == 1
%         color_range=[-6 6];
% %         colormap_mat='cmap_hunki_tmap.mat';
%         colormap_mat='cmap_hunki_tmap_raw.mat';
%         colormap_label='t-score';
...
%         thr=0.0001;
%         cluster_stats_i=1;
%         displayElectrodesInflated_new_fs_stat(data_location,patients, overlay, laterality, views,thr,color_range,colormap_mat, ...
%             file_suffix,storage_suffix,Montage_suffix,cluster_stats_all{cluster_stats_i},atlas_storage_folder,atlas_index,flip_prefix)
%         stats_storage_folder=[image_storage_folder '\' atlas_index '_tval'];
%         display_dynamic_HK(stats_storage_folder,flip_flag,colormap_mat,color_range,colormap_label)
%         close all;
        ...
        thr=0.0001;
        cluster_stats_i=1;
        displayElectrodesInflated_new_fs_zscore(data_location,patients, overlay, laterality, views,thr,color_range,colormap_mat, ...
            file_suffix,storage_suffix,Montage_suffix,cluster_stats_all{cluster_stats_i},atlas_storage_folder,atlas_index,flip_prefix)
        stats_storage_folder=[image_storage_folder '\' atlas_index '_zval'];
        display_dynamic_HK(stats_storage_folder,flip_flag,colormap_mat,color_range,colormap_label)
        close all;

    elseif zscore_mapping_stats_flag == 1
        thr=1;
        color_range=z_color_range;
        ...
        for cluster_stats_i=1:size(cluster_stats_all,2)
            for time_i=[5]
                displayElectrodesInflated_new_fs_stat_cluster_zscore(data_location,patients, overlay, laterality, views,thr,color_range,colormap_mat, ...
...
switch stats_method
    ...
    case 'cluster_sumt_rand_005'
        [pval, t_orig, clust_info, seed_state, est_alpha, mn_clust_mass]=clust_perm1_iceeg_sumt_rand(both_mean_vertex_values,roi_neighbor_matrix,2000,0.05,0,0.05,2,[],0);
        save(['cluster_sumt_rand_005_' atlas_index '_' file_suffix '_' flip_prefix  '.mat'],'pval','t_orig','clust_info','seed_state','est_alpha','mn_clust_mass' ...
        ,'both_mean_vertex_values');

    case 'cluster_sumt_rand_001'
        [pval, t_orig, clust_info, seed_state, est_alpha, mn_clust_mass]=clust_perm1_iceeg_sumt_rand(both_mean_vertex_values,roi_neighbor_matrix,2000,0.05,0,0.01,2,[],0);
        save(['cluster_sumt_rand_001_' atlas_index '_' file_suffix '_' flip_prefix  '.mat'],'pval','t_orig','clust_info','seed_state','est_alpha','mn_clust_mass' ...
        ,'both_mean_vertex_values');
    
    case 'cluster_sumt_rand_0005'
        [pval, t_orig, clust_info, seed_state, est_alpha, mn_clust_mass]=clust_perm1_iceeg_sumt_rand(both_mean_vertex_values,roi_neighbor_matrix,2000,0.05,0,0.005,2,[],0);
        save(['cluster_sumt_rand_0005_' atlas_index '_' file_suffix '_' flip_prefix  '.mat'],'pval','t_orig','clust_info','seed_state','est_alpha','mn_clust_mass' ...
        ,'both_mean_vertex_values');    

    case 'cluster_sumt_rand_000001'
        [pval, t_orig, clust_info, seed_state, est_alpha, mn_clust_mass]=clust_perm1_iceeg_sumt_rand(both_mean_vertex_values,roi_neighbor_matrix,2000,0.05,0,0.00001,2,[],0);
        save(['cluster_sumt_rand_000001_' atlas_index '_' file_suffix '_' flip_prefix  '.mat'],'pval','t_orig','clust_info','seed_state','est_alpha','mn_clust_mass' ...
        ,'both_mean_vertex_values');  
