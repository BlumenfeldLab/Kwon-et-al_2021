...
function displayElectrodesInflated_single(image_storage_folder, overlay,laterality, views, inflationstep,L_vertex_values_frame,R_vertex_values_frame)
...
colors = distinguishable_colors(236);
...
%         load('cmap_hunki_new');
        ...
        for frame_index = 1:total_num_frames
            ...
            if side_index == 1
                vertex_values_frame=L_vertex_values_frame;
            else
                vertex_values_frame=R_vertex_values_frame;
            end
            ...
            if overlay == 2 || overlay == 3 || overlay == 4
                ...
                h = patch('Faces',inflated_surf(side_index).faces, 'Vertices', inflated_surf(side_index).vertices,...
                    'FaceVertexCData',vertex_values_frame(:, 1),'FaceColor','flat',...
