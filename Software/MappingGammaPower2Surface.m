function MappingGammaPower2Surface(i,subject_name)
...
%     fs_surf(side_index) = export(gifti(surf_fn));
    ...
    for e = 1:electrode_mapping_times
        ...
        vertex_values_e=zeros(v_num,total_num_frames);
...
%                             vertexCdata            = zeros(v_num, 1);
                    ...
                    [vertexCdata]        = CalculateTransparency(v_num, fs_surf(side_index).vertices, elecVertices, electrode_vertex_values, overlay);
                    
                    vertex_values(:,frame_index) = vertexCdata;
                    vertex_values_e(elecVertices,frame_index)=electrode_vertex_values;
                end
            end
        end
        save([side '_vertex_values_' file_suffix '.mat'],'vertex_values','vertex_values_e');
    end
end
